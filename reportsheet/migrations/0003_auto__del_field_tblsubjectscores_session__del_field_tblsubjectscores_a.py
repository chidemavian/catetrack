...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'tblsubjectScores.session'
        db.delete_column(u'reportsheet_tblsubjectscores', 'session')

        # Deleting field 'tblsubjectScores.arm'
        db.delete_column(u'reportsheet_tblsubjectscores', 'arm')

        # Deleting field 'tblsubjectScores.term'
        db.delete_column(u'reportsheet_tblsubjectscores', 'term')

        # Deleting field 'tblsubjectScores.klass'
        db.delete_column(u'reportsheet_tblsubjectscores', 'klass')

        # Adding field 'tblsubjectScores.subject_teacher_comment_endterm'
        db.add_column(u'reportsheet_tblsubjectscores', 'subject_teacher_comment_endterm',
    ...
    def backwards(self, orm):
        # Adding field 'tblsubjectScores.session'
        db.add_column(u'reportsheet_tblsubjectscores', 'session',
                      self.gf('django.db.models.fields.CharField')(default='2', max_length=20),
                      keep_default=False)

        # Adding field 'tblsubjectScores.arm'
        db.add_column(u'reportsheet_tblsubjectscores', 'arm',
                      self.gf('django.db.models.fields.CharField')(default='2', max_length=10),
                      keep_default=False)

        # Adding field 'tblsubjectScores.term'
        db.add_column(u'reportsheet_tblsubjectscores', 'term',
                      self.gf('django.db.models.fields.CharField')(default='2', max_length=20),
                      keep_default=False)

        # Adding field 'tblsubjectScores.klass'
        db.add_column(u'reportsheet_tblsubjectscores', 'klass',
                      self.gf('django.db.models.fields.CharField')(default='2', max_length=20),
                      keep_default=False)

        # Deleting field 'tblsubjectScores.subject_teacher_comment_endterm'
        db.delete_column(u'reportsheet_tblsubjectscores', 'subject_teacher_comment_endterm')
