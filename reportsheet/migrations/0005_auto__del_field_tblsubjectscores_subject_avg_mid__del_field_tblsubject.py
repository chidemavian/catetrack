...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'tblsubjectScores.subject_avg_mid'
        db.delete_column(u'reportsheet_tblsubjectscores', 'subject_avg_mid')

        # Deleting field 'tblsubjectScores.subposition_endterm'
        db.delete_column(u'reportsheet_tblsubjectscores', 'subposition_endterm')

        # Deleting field 'tblsubjectScores.subject_avg_endterm'
        db.delete_column(u'reportsheet_tblsubjectscores', 'subject_avg_endterm')

        # Adding field 'tblsubjectScores.stream_subject_avg_endterm'
        db.add_column(u'reportsheet_tblsubjectscores', 'stream_subject_avg_endterm',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=4, decimal_places=2),
                      keep_default=False)

        # Adding field 'tblsubjectScores.classroom_subject_avg_endterm'
        db.add_column(u'reportsheet_tblsubjectscores', 'classroom_subject_avg_endterm',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=4, decimal_places=2),
                      keep_default=False)

        # Adding field 'tblsubjectScores.classroom_subject_avg_mid'
        db.add_column(u'reportsheet_tblsubjectscores', 'classroom_subject_avg_mid',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=4, decimal_places=2),
                      keep_default=False)

        # Adding field 'tblsubjectScores.stream_subposition_endterm'
        db.add_column(u'reportsheet_tblsubjectscores', 'stream_subposition_endterm',
                      self.gf('django.db.models.fields.CharField')(default='N/A', max_length=10),
                      keep_default=False)

        # Adding field 'tblsubjectScores.classroom_subposition_endterm'
        db.add_column(u'reportsheet_tblsubjectscores', 'classroom_subposition_endterm',
                      self.gf('django.db.models.fields.CharField')(default='N/A', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'tblsubjectScores.subject_avg_mid'
        db.add_column(u'reportsheet_tblsubjectscores', 'subject_avg_mid',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=4, decimal_places=2),
                      keep_default=False)

        # Adding field 'tblsubjectScores.subposition_endterm'
        db.add_column(u'reportsheet_tblsubjectscores', 'subposition_endterm',
                      self.gf('django.db.models.fields.CharField')(default='N/A', max_length=10),
                      keep_default=False)

        # Adding field 'tblsubjectScores.subject_avg_endterm'
        db.add_column(u'reportsheet_tblsubjectscores', 'subject_avg_endterm',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=4, decimal_places=2),
                      keep_default=False)

        # Deleting field 'tblsubjectScores.stream_subject_avg_endterm'
        db.delete_column(u'reportsheet_tblsubjectscores', 'stream_subject_avg_endterm')

        # Deleting field 'tblsubjectScores.classroom_subject_avg_endterm'
        db.delete_column(u'reportsheet_tblsubjectscores', 'classroom_subject_avg_endterm')

        # Deleting field 'tblsubjectScores.classroom_subject_avg_mid'
        db.delete_column(u'reportsheet_tblsubjectscores', 'classroom_subject_avg_mid')

        # Deleting field 'tblsubjectScores.stream_subposition_endterm'
        db.delete_column(u'reportsheet_tblsubjectscores', 'stream_subposition_endterm')

        # Deleting field 'tblsubjectScores.classroom_subposition_endterm'
        db.delete_column(u'reportsheet_tblsubjectscores', 'classroom_subposition_endterm')
