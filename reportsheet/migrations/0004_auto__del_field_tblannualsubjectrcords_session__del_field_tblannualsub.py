...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'tblannualsubjectrcords.session'
        db.delete_column(u'reportsheet_tblannualsubjectrcords', 'session')

        # Deleting field 'tblannualsubjectrcords.term'
        db.delete_column(u'reportsheet_tblannualsubjectrcords', 'term')

        # Deleting field 'tblannualsubjectrcords.klass'
        db.delete_column(u'reportsheet_tblannualsubjectrcords', 'klass')

        # Deleting field 'tblannualsubjectrcords.arm'
        db.delete_column(u'reportsheet_tblannualsubjectrcords', 'arm')


    def backwards(self, orm):
        # Adding field 'tblannualsubjectrcords.session'
        db.add_column(u'reportsheet_tblannualsubjectrcords', 'session',
                      self.gf('django.db.models.fields.CharField')(default='23', max_length=20),
                      keep_default=False)

        # Adding field 'tblannualsubjectrcords.term'
        db.add_column(u'reportsheet_tblannualsubjectrcords', 'term',
                      self.gf('django.db.models.fields.CharField')(default='trtj', max_length=20),
                      keep_default=False)

        # Adding field 'tblannualsubjectrcords.klass'
        db.add_column(u'reportsheet_tblannualsubjectrcords', 'klass',
                      self.gf('django.db.models.fields.CharField')(default='kh', max_length=20),
                      keep_default=False)

        # Adding field 'tblannualsubjectrcords.arm'
        db.add_column(u'reportsheet_tblannualsubjectrcords', 'arm',
                      self.gf('django.db.models.fields.CharField')(default='jf', max_length=10),
                      keep_default=False)
