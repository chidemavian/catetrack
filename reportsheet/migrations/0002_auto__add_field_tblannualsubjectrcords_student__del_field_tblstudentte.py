...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'tblannualsubjectrcords.student'
        db.add_column(u'reportsheet_tblannualsubjectrcords', 'student',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='2', to=orm['student.tblclassroom']),
                      keep_default=False)

        # Deleting field 'tblstudenttermlyrecord.session'
        db.delete_column(u'reportsheet_tblstudenttermlyrecord', 'session')

        # Deleting field 'tblstudenttermlyrecord.arm'
        db.delete_column(u'reportsheet_tblstudenttermlyrecord', 'arm')

        # Deleting field 'tblstudenttermlyrecord.term'
        db.delete_column(u'reportsheet_tblstudenttermlyrecord', 'term')

        # Deleting field 'tblstudenttermlyrecord.klass'
        db.delete_column(u'reportsheet_tblstudenttermlyrecord', 'klass')

        # Adding field 'tblstudenttermlyrecord.subject_teacher_comment_endterm'
        db.add_column(u'reportsheet_tblstudenttermlyrecord', 'subject_teacher_comment_endterm',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=3000),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'tblannualsubjectrcords.student'
        db.delete_column(u'reportsheet_tblannualsubjectrcords', 'student_id')

        # Adding field 'tblstudenttermlyrecord.session'
        db.add_column(u'reportsheet_tblstudenttermlyrecord', 'session',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=20),
                      keep_default=False)

        # Adding field 'tblstudenttermlyrecord.arm'
        db.add_column(u'reportsheet_tblstudenttermlyrecord', 'arm',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=10),
                      keep_default=False)

        # Adding field 'tblstudenttermlyrecord.term'
        db.add_column(u'reportsheet_tblstudenttermlyrecord', 'term',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True),
                      keep_default=False)

        # Adding field 'tblstudenttermlyrecord.klass'
        db.add_column(u'reportsheet_tblstudenttermlyrecord', 'klass',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=20),
                      keep_default=False)

        # Deleting field 'tblstudenttermlyrecord.subject_teacher_comment_endterm'
        db.delete_column(u'reportsheet_tblstudenttermlyrecord', 'subject_teacher_comment_endterm')
