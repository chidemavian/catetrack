...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'tblannualsubjectrcords.remark_annual'
        db.delete_column(u'reportsheet_tblannualsubjectrcords', 'remark_annual')

        # Deleting field 'tblannualsubjectrcords.grade_annual'
        db.delete_column(u'reportsheet_tblannualsubjectrcords', 'grade_annual')

        # Deleting field 'tblannualsubjectrcords.subject_avg_annual'
        db.delete_column(u'reportsheet_tblannualsubjectrcords', 'subject_avg_annual')

        # Deleting field 'tblannualsubjectrcords.classroo_subject_position_annual'
        db.delete_column(u'reportsheet_tblannualsubjectrcords', 'classroo_subject_position_annual')

        # Adding field 'tblannualsubjectrcords.annual_grade'
        db.add_column(u'reportsheet_tblannualsubjectrcords', 'annual_grade',
                      self.gf('django.db.models.fields.CharField')(default='F', max_length=3),
                      keep_default=False)

        # Adding field 'tblannualsubjectrcords.annual_remark'
        db.add_column(u'reportsheet_tblannualsubjectrcords', 'annual_remark',
                      self.gf('django.db.models.fields.CharField')(default='ee', max_length=60),
                      keep_default=False)

        # Adding field 'tblannualsubjectrcords.annual_subject_avg'
        db.add_column(u'reportsheet_tblannualsubjectrcords', 'annual_subject_avg',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=4, decimal_places=2),
                      keep_default=False)

        # Adding field 'tblannualsubjectrcords.annual_subject_position_classroom'
        db.add_column(u'reportsheet_tblannualsubjectrcords', 'annual_subject_position_classroom',
                      self.gf('django.db.models.fields.CharField')(default='N/A', max_length=10),
                      keep_default=False)

        # Adding field 'tblannualsubjectrcords.annual_subject_position_stream'
        db.add_column(u'reportsheet_tblannualsubjectrcords', 'annual_subject_position_stream',
                      self.gf('django.db.models.fields.CharField')(default='N/A', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'tblannualsubjectrcords.remark_annual'
        db.add_column(u'reportsheet_tblannualsubjectrcords', 'remark_annual',
                      self.gf('django.db.models.fields.CharField')(default='e', max_length=60),
                      keep_default=False)

        # Adding field 'tblannualsubjectrcords.grade_annual'
        db.add_column(u'reportsheet_tblannualsubjectrcords', 'grade_annual',
                      self.gf('django.db.models.fields.CharField')(default='F', max_length=3),
                      keep_default=False)

        # Adding field 'tblannualsubjectrcords.subject_avg_annual'
        db.add_column(u'reportsheet_tblannualsubjectrcords', 'subject_avg_annual',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=4, decimal_places=2),
                      keep_default=False)

        # Adding field 'tblannualsubjectrcords.classroo_subject_position_annual'
        db.add_column(u'reportsheet_tblannualsubjectrcords', 'classroo_subject_position_annual',
                      self.gf('django.db.models.fields.CharField')(default='N/A', max_length=10),
                      keep_default=False)

        # Deleting field 'tblannualsubjectrcords.annual_grade'
        db.delete_column(u'reportsheet_tblannualsubjectrcords', 'annual_grade')

        # Deleting field 'tblannualsubjectrcords.annual_remark'
        db.delete_column(u'reportsheet_tblannualsubjectrcords', 'annual_remark')

        # Deleting field 'tblannualsubjectrcords.annual_subject_avg'
        db.delete_column(u'reportsheet_tblannualsubjectrcords', 'annual_subject_avg')

        # Deleting field 'tblannualsubjectrcords.annual_subject_position_classroom'
        db.delete_column(u'reportsheet_tblannualsubjectrcords', 'annual_subject_position_classroom')

        # Deleting field 'tblannualsubjectrcords.annual_subject_position_stream'
        db.delete_column(u'reportsheet_tblannualsubjectrcords', 'annual_subject_position_stream')
    ...
    models = {
        ...
        u'reportsheet.tblannualsubjectrcords': {
            ...
            'annual_grade': ('django.db.models.fields.CharField', [], {'default': "'F'", 'max_length': '3'}),
            'annual_remark': ('django.db.models.fields.CharField', [], {'max_length': '60'}),
            'annual_subject_avg': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '4', 'decimal_places': '2'}),
            'annual_subject_position_classroom': ('django.db.models.fields.CharField', [], {'default': "'N/A'", 'max_length': '10'}),
            'annual_subject_position_stream': ('django.db.models.fields.CharField', [], {'default': "'N/A'", 'max_length': '10'}),
            'branch': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['business.tblbranch']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
