...
urlpatterns = patterns('assessment.views',
    ...
    url(r'^student/my_broadsheet/$','my_broad_page'),

    # url(r'^student/my_results_page/halfterm/$','halfterm_student'),
    ...
    url(r'^editcas2/(\d+)/$', 'editcas2'),   #mid term magana***************
     ...
     url(r'^editcas2both/(\d+)/$', 'editcas2bothtypespp'),#both CAs magana new
  # url(r'^editcas2both/(\d+)/$', 'editcas2bothtypes'),   #both CAs magana old sch*********
...
####******************************PERFORMANCES*********************
    url(r'^performance/selection/$', 'selsubject'),    
     url(r'^getperformsubject/$', 'pefsubject'),
     # url(r'^getstudentperf/$', 'getstudentperf'),

    url(r'^performance/overall/$', 'seloverall'),    
     # url(r'^getperformsubject/$', 'pefsubject'),
     url(r'^getstudentoverallperf/$', 'getstudentoverallperf'),
