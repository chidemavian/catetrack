...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'tblclassroom.second_term'
        db.delete_column(u'student_tblclassroom', 'second_term')

        # Deleting field 'tblclassroom.first_term'
        db.delete_column(u'student_tblclassroom', 'first_term')

        # Deleting field 'tblclassroom.third_term'
        db.delete_column(u'student_tblclassroom', 'third_term')

        # Adding field 'tblclassroom.term'
        db.add_column(u'student_tblclassroom', 'term',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'tblclassroom.second_term'
        db.add_column(u'student_tblclassroom', 'second_term',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'tblclassroom.first_term'
        db.add_column(u'student_tblclassroom', 'first_term',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'tblclassroom.third_term'
        db.add_column(u'student_tblclassroom', 'third_term',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'tblclassroom.term'
        db.delete_column(u'student_tblclassroom', 'term')
